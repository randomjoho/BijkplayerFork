...
Pod::Spec.new do |spec|
  ...
  spec.name         = "BIJKPlayerFork"
  spec.version      = "0.7.8"
  spec.summary      = "A short description of BIJKPlayerFork."
  ...
  spec.author             = { "random" => "283739569@qq.com" }
  ...
  spec.source = { :http => "https://github.com/randomjoho/BijkplayerFork/blob/main/IJKMediaPlayer.tar.gz" }
